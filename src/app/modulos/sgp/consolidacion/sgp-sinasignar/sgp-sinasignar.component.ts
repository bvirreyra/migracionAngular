...
@Component({
  selector: "app-sgp-sinasignar",
  templateUrl: "./sgp-sinasignar.component.html",
  styleUrls: ["./sgp-sinasignar.component.css"],
  providers: [
...
export class SgpSinasignarComponent implements OnInit {
  ...
  paneles(string) {
    if (string == "VER_LISTAPROYECTOS") {
      this.m_titulo = "Proyectos Sgp sin asignar";
      this.listaproyectosparavalidacion();
    }
  }
  listaproyectosparavalidacion() {
    this.cargando = true;
    this._seguimiento.listaProyectosParaConsolidarV3().subscribe(
      (result: any) => {
