...
@Component({
  selector: "app-mae-beneficiaria",
  templateUrl: "./mae-beneficiaria.component.html",
  styleUrls: ["./mae-beneficiaria.component.css"],
  providers: [
...
export class MaeBeneficiariaComponent implements OnInit {
