...
export class MMenuComponent implements OnInit {
  ...
  public pnlModalNuevoMenu = false;
  ...
  BuscarMenu() {
    ...
    this._mmenu.getListarMenu(this.m_descripcion, this.m_ruta).subscribe(
      (result: any) => {
  ...
  MuestraMenu(datos) {
    ...
    this.e_idmenusuperior = this.dtsRegitroProveido.id_menusuperior;
    this.e_orden = this.dtsRegitroProveido.orden;
    this.e_nivel = this.dtsRegitroProveido.nivel;
  ...
  ActualizaMenu() {
    ...
    this._mmenu
      .getActualizaMenu(
        this.e_idmenu,
        this.e_descripcion,
        this._fun.getNullVacio(this.e_idmenusuperior),
        this.e_orden,
        this.e_nivel,
        this.e_icono,
        this.e_ruta.replace("./", ""),
  ...
  FormNuevoMenu(datos) {
    this.pnlModalNuevoMenu = true;
    this.e_idmenu = "";
    this.e_descripcion = "";
    this.e_idmenusuperior = "";
    this.e_orden = "";
    this.e_nivel = "";
    this.e_icono = "";
    this.e_ruta = "";
  ...
  EliminaRegistroActual(id_menu: any) {
    //console.log(this.m_prov_fecha);
    this._mmenu.getEliminaRegistroMenu(id_menu).subscribe(
      (result: any) => {
